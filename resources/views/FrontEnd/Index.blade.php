    ...
    <div class="col">
      ...
      <div class="container" id="GOTO"  >
        ...
        <div class="buttons mb-2">
          <a href="{{ route('login_form') }}" ><button class="button" id="first" > Physics</button></a>
          <a href="{{ route('login_form') }}" ><button class="button" id="second">Chemistry</button></a>
        </div>
      </div>
