...
<head>
  ...
  <!-- logo icons -->
  <link href="{{asset('images/Logo/logo-principal.svg')}}" rel="icon">
  <!-- Add icon library -->
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
  ...
  <!-- CSS File -->
  <link href="{{asset('css/style_page_admin.css')}}" rel="stylesheet">
...
<body>
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="d-flex align-items-center justify-content-between">
      <a href="/" class="logo d-flex align-items-center">
        <img src="{{asset('images/logo-principal.svg')}}" alt="">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow messages">
            ...
            <li class="message-item">
              <a href="#">
                <img src="{{asset('images/messages.jpg')}}" alt="" class="rounded-circle">
                <div>
                  <h4>Toumi </h4>
    ...
    <section id="1" class="section dashboard on">
      ...
      <footer class="text-center text-lg-start bg-light text-muted">
          ...
          <div class="container text-center text-md-start mt-5">
            ...
            <div class="row mt-3">
              ...
              <div class="col-md-3 col-lg-2 col-xl-2 mx-auto mb-4">
                ...
                <p>
                  <a href="#!" class="text-reset">TPs chimie</a>
                </p>
                <p>
        ...
        <div class="text-center p-4" style="background-color: rgba(0, 0, 0, 0.05);">
          © 2022 Copyright.
          <a class="text-reset fw-bold" href="/">UnivLab3D</a>
        </div>
        <!-- Copyright -->
      </footer>
      <!-- Footer -->
                  ...
                  <div class="modal-body">
                    ...
                    <form class="row g-2">
                      <div class="col-md-6">
                        ...
                        <input type="text" class="form-Title col-md-12" id="validationDefault01" placeholder="First name" required>
                      </div>
                      <div class="col-md-6">
                        <label for="validationDefault02" class="form-label"><strong>Last name</strong> </label>
                        <input type="text" class="form-Title col-md-12" id="validationDefault02" placeholder="Last name" required>
                      </div>
                      <div class="col-md-12">
                        <label for="validationDefault02" class="form-label"><strong>E-mail adress</strong> </label>
                        <input type="text" class="form-Title col-md-12" id="validationDefault02"  aria-describedby="inputGroupPrepend2" placeholder="example@univ-setif.dz" required>

                      </div>

                      <div class="col-md-12">
                        <label for="validationDefault02" class="form-label"><strong>Departement</strong> </label>
                        <select class="form-Title col-md-12" id="validationDefault02" required>
                      ...
                      <div class="col-md-6">
                        <label for="validationDefault02" class="form-label"><strong>Password</strong> </label>
                        <input type="password" class="form-Title col-md-12" id="validationDefault02" placeholder="Password" required>

                      </div>
                      <div class="col-md-6">
                        <label for="validationDefault02" class="form-label"><strong>Confirm password</strong> </label>
                        <input type="password" class="form-Title col-md-12" id="validationDefault02" placeholder="Confirm password" required>
            ...
            <table id="example" class="table table-hover" style="width:100%">
              ...
              <tbody>
                <tr>
                    ...
                    <td>Douar</td>
                    <td>Physique</td>
                    <td>amel.douar@univ-setif.dz</td>
            ...
            <div class="modal fade" id="mewModule" tabindex="-1" aria-labelledby="ModalLabel" aria-hidden="true">
              <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    <form class="containermodal" method="get" action="">
                      <input class="form-Title" type="text" placeholder="Title" name="Title" required>
                      <div class="form-slc">
                        <div>
                        ...
                        <div>
                          ...
                          <select id="Specialization" name="Specialization" required>
                            ...
                            <optgroup label="Physique">
                              ...
                              <option value="Physique des Rayonnements"> Physique des Rayonnements</option>
                              <option value="Physique Médicale"> Physique Médicale</option>
                              <option value="Physique du Globe"> Physique du Globe</option>
                            </optgroup>
                            <optgroup label="Chimie">
                              ...
                              <option value="Chimie Pharmaceutique"> Chimie Pharmaceutique </option>
                            </optgroup>
                          </select>
                        </div>
                        <div>
                      ...
                      <input class="form-Teacher" type="text" placeholder="Responsable" name="Teacher" required>
            ...
            <table id="example" class="table table-hover" style="width:100%">
              ...
              <tbody>
                <tr >
                    ...
                    <td>Science</td>
                    <td>Physique</td>
                    <td>Physique des Matériaux</td>
                    <td>Licence 3</td>


                    <td><i class="fa fa-trash bx-tada-hover btn2000" onClick=""></i></td>
  ...
  <script src="{{asset('js/main_page_admin.js')}}"></script>
