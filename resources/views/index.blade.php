...
<head>
  ...
  <title>UnivLab</title>
  <link rel="stylesheet" href="{{asset('css/style_landing.css')}}" />f
    <link
      rel="stylesheet"
      href="{{asset('vendor/fontawesome-free-6.2.0-web/css/all.css')}}"
    />
    ...
    <!-- Container wrapper -->
     <div class="container">
            ...
            <a class="navbar-brand" id="brand" href="/" >
              <img src="{{asset('images/univlablogo2.svg')}}"
                height="35"
                alt="UnivLab3D"
                loading="lazy"
              />
                 ...
                 <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                  <li class="nav-item">
                    ...
                    <div class="d-flex align-items-center">
                      <a href="/ulogin" ><button type="button" class="btn  px-3 me-2" id="btn3">
                             LogIn
                         </button></a>
                         <a href="/ulogin"><button type="button" id="btn1" class="btn btn-primary me-3">
                            SignUp
                         </button></a>
                    </div>
                    ...
                    <div class="nav-item dropdown no-arrow pe-3">
                        ...
                        <a class="nav-link nav-profile d-flex align-items-center dropdown-toggle pe-0" href="#"
                          ...
                          <img src="{{asset('images/man.png')}}" alt="Profile" class="rounded-circle">
    ...
    <div  class="row">
        <div class="row">
            <div class="col" id="col1">
                       <img
                         src="{{asset('images/Virtual reality-amico.svg')}}"
                         height="500"
                       />
            </div>
    ...
    <div class="col">
        ...
        <div class="container" >
          ...
          <div class="cards">
            <label for="s1" id="slide1">
              <div class="card">
                <div class="image">
                  <img src="{{asset('/images/scientist3.jpg')}}" alt="">
            ...
            <label for="s2" id="slide2">
              <div class="card">
                <div class="image">
                  <img src="{{asset('/images/science.jpg')}}" alt="">
            ...
            <label for="s4" id="slide4">
              <div class="card">
                <div class="image">
                  <img src="{{asset('images/articles.jpg')}}" alt="">
      ...
      <div class="container" id="GOTO"  >
        ...
        <div class="buttons mb-2">
          <a href="/home_physics"><button class="button" id="first" > Physics</button></a>
          <a href="/home_chemistry"><button class="button" id="second">Chemistry</button></a>
        </div>
      </div>
