...
<head>
  ...
  <link
    ...
    <!-- CSS File -->
    <link href="{{asset('css/style_Chemistry.css')}}" rel="stylesheet">
...
<body class="main" >
    ...
    <div class="col-sm-4 col-12 p-0 m-0 d-flex text-center align-items-center justify-content-center">
      <div class="d-block">
        <div class="d-flex align-items-center justify-content-center">
          <img class="p-3 text-center" src="{{asset('images/tubes1.png')}}" alt="lab tubes">
        </div>
        ...
        <div class="view_wrap list-view" style="display: block;">
          <div class="view_item rounded-4">
            ...
            <div class="vi_right">
              ...
              <div class="btn"><a class="text-white" href="/lab_chemistry"> View More </a></div>
            </div>
          </div>
          <div class="view_item rounded-4">
            <div class="vi_left">
  ...
  <div id="labs2" class="row p-0 m-0" style="width: 95vw;">
    ...
    <div class="col-sm-4 col-12 p-0 m-0 d-flex text-center align-items-center justify-content-center">
      <div class="d-block">
        <div class="d-flex align-items-center justify-content-center">
          <img src="{{asset('images/tubes2.png')}}" alt="lab tubes">
        </div>
...
<div id="explore1" class="container-fluid vh-100">
  <div class="row">
      <div class="col-sm-4 left col-12">
        ...
        <div class="row imd">
          <img src="{{asset('images/ss2.png')}}" alt="" srcset="">
        </div>
        <div class="row btns">
  ...
  <div class="row vh-100">
    <div class="col-sm-8 col-12 right">
      ...
      <div class="col-sm-4 col-12 left">
        ...
        <div class="row imd2">
          <img src="{{asset('images/ss.png')}}" alt="" srcset="">
        </div>
        <div class="row descc">
