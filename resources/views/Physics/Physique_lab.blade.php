...
<head>
  ...
  <link href="../assets/vendor/bootstrap-icons/bootstrap-icons.css" rel="stylesheet">	<link rel="stylesheet" href="../assets/css/style_Physique_lab.css">
	
  <title>Physique Lab</title>
</head>
<body>
  ...
  <div class="container ee">
	...
	<div class="container ee">
		<input type="file" id="file" accept="img/*" hidden>
		<div class="img-area" data-img="">
			<i class='bx bxs-cloud-upload icon'></i>
			<h3>Upload Lab</h3>
		</div>
		<button type="button" class="select-image"><i class="fa-solid fa-plus"></i></button>
  ...
  <div class="container">
	...
	<script src="https://kit.fontawesome.com/120751985e.js" crossorigin="anonymous"></script>
  <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/js/bootstrap.bundle.min.js" integrity="sha384-MrcW6ZMFYlzcLA8Nl+NtUVF0sA7MsXsP1UyJoMp4YLEuNSfAP+JcXn/tWtIaxVXM" crossorigin="anonymous"></script>
	<script src="../assets/js/script_Physique_lab.js"></script>
</body>
</html>