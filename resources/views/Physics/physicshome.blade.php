...
<head>
  ...
  <link
    ...
    rel="stylesheet">
    <!-- logo icons -->
    <link href="{{asset('images/logo-principal.svg')}}" rel="icon">
    ...
    <!-- CSS File -->
    <link href="{{asset('css/style_Physique.css')}}" rel="stylesheet">
    <link href="{{asset('css/style_landing.css')}}" rel="stylesheet">
    <link href="{{asset('css/animated-bg.css')}}" rel="stylesheet">
</head>
...
<body class="main">
        ...
        <div class="container">
          ...
          <div class="hero-content">
            ...
            <figure class="hero-banner d-none">
              <img src="{{asset('images/undraw_Science_re_mnnr-removebg-preview.png')}}" alt="Hero image">
            </figure>
          </div>
        </div>
      </section>
    ...
    <div class="col-sm-4 col-12 p-0 m-0 d-flex text-center align-items-center justify-content-center">
      <div class="d-block">
        <div class="d-flex align-items-center justify-content-center">
          <img class="p-3 text-center" src="{{asset('images/scientist_left.png')}}" alt="lab tubes">
        </div>
      ...
      <div class="view_main">
        ...
        <div class="view_wrap list-view" style="display: block;">
          <div class="view_item rounded-4">
            <div class="vi_left">
              <img src="{{asset('images/chemistry-lab.png')}}" alt="lab">
            </div>
            <div class="vi_right">
              ...
              <div class="btn"><a class="text-white" href="/lab_physics"> View More </a></div>
            </div>
          </div>
          <div class="view_item rounded-4">
            <div class="vi_left">
          ...
          <div class="container-fluid">
            <div class="row row-cols-3 text-center">
              <div class="view_item rounded-4 col">
                <div class="vi_left">
                  <img src="{{asset('images/chemistry-lab.png')}}" alt="Lab img">
                </div>
                <div class="vi_right">
                  <p class="title">Lab 1</p>
                  <p class="content">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aperiam impedit, veniam! Voluptate a impedit animi!</p>
  ...
  <div id="labs2" class="row p-0 m-0" style="width: 95vw;">
    ...
    <div class="col-sm-4 col-12 p-0 m-0 d-flex text-center align-items-center justify-content-center">
      <div class="d-block">
        <div class="d-flex align-items-center justify-content-center">
          <img src="{{asset('images/scientist_right.png')}}" alt="lab tubes">
        </div>
...
<div id="explore1" class="main container-fluid vh-100">
  <div class="row">
      <div class="col-sm-4 left col-12">
        <div class="row logo">
            <img src="{{asset('images/test.png')}}" alt="" srcset="">
        </div>
        <div class="row title">
          <h1>3D ONLINE<br>LABORATORY</h1>
        </div>
        <div class="row imd">
          <img src="{{asset('images/scientist_left.png')}}" alt="" srcset="">
        </div>
        <div class="row btns">
      ...
      <div class="col-sm-8 col-12 right">
        <div class="lab">
          <img src="{{asset('images/table_chaise.png')}}" alt="">
        </div>
        <div class="des">
  ...
  <div class="row vh-100">
    <div class="col-sm-8 col-12 right">
      ...
      <div class="col-sm-4 col-12 left">
        ...
        <div class="row imd2">
          <img src="{{asset('images/scientist_right.png')}}" alt="" srcset="">
        </div>
        <div class="row descc">
...
<footer id="footer" class="text-center text-lg-start text-white mt-2" style="font-family: 'Poppins', sans-serif; background-color:HSL(19, 97%, 37%);">
  ...
  <script src="{{asset('js/script_Ch_ph.js')}}"></script>
