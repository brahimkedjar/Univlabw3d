      ...
      >
          ...
          >
            ...
            <div class="ms-5 mt-5 d-flex justify-content-start align-items-end" >
              <img
                src="{{asset('images/businessman-removebg-preview 1.png')}}"
                alt="Generic placeholder image"
                class="img-fluid mt-5 ms-5 "
                style="width: 100px; z-index: 1 ;"
              />

              <h3 class="mb-5 ms-4">Student Username</h3>
      ...
      <div class="row  d-flex justify-content-center align-items-center">
        ...
        <div class="row row-cols-2  ">
          <div class="col text-start text-center">
            <h6>Full Name</h6>
            <p class="text-muted">full_Student_name</p>
          </div>
          <div class="col text-start text-center">
            <h6>E-mail</h6>
        ...
        <div class="col-12 text-center">
            <img src="{{asset('images/Researchers-pana (1).svg')}}" class="img-fluid" style="height: 600px;" alt="">
          </div>
